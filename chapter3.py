...
# # Bagian MoviePy: Memuat, memanipulasi, dan menyimpan video
# video = VideoFileClip('example.mp4')

# # Menyimpan file video asli
...
# # Menggabungkan video asli dengan klip pendek
...
# Bagian Tkinter: Membuat antarmuka pengguna dan menampilkan gambar
root = tk.Tk()
